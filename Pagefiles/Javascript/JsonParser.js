...
console.log("new list structure loaded with out complaint! this is the {" + intPARSE(localStorage.getItem("dataload")) + "} time a new data set has been loaded since page was opened")
}
